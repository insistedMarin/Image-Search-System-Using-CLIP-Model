...
export default function Ampligram(props) {
  const {
    ...
    time,
    userName = "makavejev",
    messageImage = "https://walkabout-storage-afb6053b195159-staging.s3.eu-west-3.amazonaws.com/abas.png",
    userPhoto = "https://walkabout-storage-afb6053b195159-staging.s3.eu-west-3.amazonaws.com/max.jpg",
    title,
    overrides,
    ...rest
  } = props;
