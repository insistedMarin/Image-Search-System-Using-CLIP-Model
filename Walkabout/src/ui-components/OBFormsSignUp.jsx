...
export default function OBFormsSignUp(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      overrides: { Name: {}, OBFormsSignUp: {} },
    ...
    {
      overrides: { Name: {}, OBFormsSignUp: { opacity: "0.6499999761581421" } },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "OBFormsSignUp")}
      {...rest}
    >
      <Text
        fontFamily="Inter"
